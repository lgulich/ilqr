...
class WheeledHopperDynamicsBodyBased(Dynamics):
    """
    An extension of the ilqr.dynamics class which hard codes the derivatives of
    the wheeled hopper model in body based coordinates
    """

    def __init__(self, dt):
        super(WheeledHopperDynamicsBodyBased, self).__init__()
        self.dt = dt
        self._state_size = 10
        self._action_size = 2
    ...
    def f(self, x, u, i):
        ...
        x = x.reshape((10, 1))
        u = u.reshape((2, 1))
        state_new = WheeledHopperNucleus.step_body_based(x, u, self.dt)
    ...
    def f_ext(self, state):
        ...
        return WheeledHopperNucleus.step_body_based(x, u, self.dt)
