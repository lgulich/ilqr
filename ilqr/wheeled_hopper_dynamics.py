...
class WheeledHopperDynamics(Dynamics):
    """
    An extension of the ilqr.dynamics class which hard codes the derivatives of
    the wheeled hopper model
    """

    def __init__(self, dt):
        super(WheeledHopperDynamics, self).__init__()
        self.dt = dt
        self._state_size = 10
        self._action_size = 2
    ...
    def f(self, x, u, i):
        ...
        x = x.reshape((10, 1))
        u = u.reshape((2, 1))
        state_new = WheeledHopperNucleus.step(x, u, self.dt)
    ...
    def f_ext(self, state):
        ...
        return WheeledHopperNucleus.step(x, u, self.dt)
